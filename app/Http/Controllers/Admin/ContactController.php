...
class ContactController extends CRUDCrontroller
{
    public function __construct(Request $request)
    {
        parent::__construct('Contact');
        $this->__request    = $request;
        $this->__data['page_title'] = 'Contact';
        $this->__indexView  = 'contact.index';
        $this->__createView = 'contact.add';
        $this->__editView   = 'contact.edit';
        $this->__detailView = 'contact.detail';
    }
