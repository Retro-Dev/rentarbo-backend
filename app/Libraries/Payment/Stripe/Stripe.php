...
class Stripe
{
    ...
    public function createAccountToken($country,$account_holder_name,$routing_number, $account_number)
    {
      try{
      
          $account = $this->_stripe->tokens->create(
            [
                'bank_account'=>[
                    'country' => $country,
                    'currency' => 'usd',
      ...
      return $this->_response = [
            'code'    => 200, //status code
            'message' => 'Generate Bank account token created successfully', //message
            'data' => [
